...
do_promote(AccountId) ->
    _ = kz_util:account_update(AccountId, fun kzd_account:promote/1),
...
do_demote(AccountId) ->
    _ = kz_util:account_update(AccountId, fun kzd_account:demote/1),
...
set_reseller_id(Reseller, Account) ->
    ...
    _ = kz_util:account_update(AccountId, fun(JObj) -> kzd_account:set_reseller_id(JObj, ResellerId) end),
