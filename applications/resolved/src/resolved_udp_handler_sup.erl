...
-module(resolved_udp_handler_sup).
...
%%%============================================================================
init([]) ->
  Server = {resolved_udp_handler_server, {resolved_udp_handler_server, start_link, []},
    temporary, 2000, worker, [resolved_udp_handler_server]},
  Children = [Server],
