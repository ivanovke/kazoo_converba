...
handle_req(JObj, _Props) ->
    ...
    {'ok', Account} = kzd_account:fetch(kz_json:get_value(<<"Account-ID">>, JObj)),
...
create_template_props(CurrentBalance, Account) ->
    Threshold = kzd_account:low_balance_threshold(kz_doc:id(Account)),
...
get_email(MasterAccountId, MasterAccountId) ->
    AccountDb = kzd_account:format_account_id(MasterAccountId, 'encoded'),
